namespace Seg
{
    ...
    //    public string taiBinVerbId;
    //    public string taiLoId;
    //    public string taiPuzId;

    //}

        public class UnNoObInput : Credentials
        {

                public string unoUnVerbId;
                public string unoLoId;
