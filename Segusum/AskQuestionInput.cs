namespace Seg
{
        ...
        public class ObjectivesSeenInput : Credentials
        {
                public string[] osiObjectivesSeen { get; set; }
        }
        public class AskQuestionInput : Credentials
        {
        ...
        public class GetNextHintInput: Credentials
        {

                public string gnh_objId;
