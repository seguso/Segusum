namespace Seg
{
        public class TerActionUnInput : Credentials
        {

                public string taiuUnVerbId;
                public string taiuLoId;
                public string taiuPuzId;

        }


        public class CancelTextInputInput : Credentials
        {

                public string ctiSerId;
